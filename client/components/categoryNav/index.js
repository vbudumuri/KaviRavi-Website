  ...
  render() {
    ...
    return(
      <section className='category-nav'>
        <h2>Portfolio</h2>
        <div className='row'>
          <div className="col-xs-2 off-xs-2 categoryNavItem">
            <a href="#" onClick={(evt) => this.setCategory(evt, 'all')}>
              All
            </a>
            <div
          ...
          <div className="col-xs-2 categoryNavItem">
            <a href="#" onClick={(evt) => this.setCategory(evt, 'digital')}>
              Digital
            </a>
            <div
              id='digital'
          ...
          <div className="col-xs-2 categoryNavItem">
            <a href="#" onClick={(evt) => this.setCategory(evt, 'print')}>
              Print
            </a>
            <div
              id='print'
          ...
          <div className="col-xs-2 categoryNavItem">
            <a href="#" onClick={(evt) => this.setCategory(evt, 'misc')}>
              Misc
            </a>
            <div
              id='misc'
